package ru.epam.homework.transportation.repo.impl;

import ru.epam.homework.common.solutions.utils.ArrayUtils;
import ru.epam.homework.storage.IdGenerator;
import ru.epam.homework.transportation.domain.Transportation;
import ru.epam.homework.transportation.repo.TransportationRepo;

import java.util.Arrays;
import java.util.Collections;
import java.util.List;

import static ru.epam.homework.common.business.repo.CommonRepoHelper.findEntityIndexInArrayStorageById;
import static ru.epam.homework.storage.Storage.transportationArray;
import static ru.epam.homework.storage.Storage.transportationIndex;
